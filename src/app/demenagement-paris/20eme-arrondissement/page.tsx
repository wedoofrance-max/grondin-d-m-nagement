...
export const metadata: Metadata = {
  title: 'Déménagement Paris 20ème — Ménilmontant, Père-Lachaise, Belleville | Grondin',
  description: 'Déménageur dans le 20ème arrondissement de Paris (Ménilmontant, Père-Lachaise, Belleville). Grondin Déménagement 7j/7, devis gratuit. 01 85 44 00 50.',
  alternates: { canonical: 'https://grondin-demenagement.fr/demenagement-paris/20eme-arrondissement' },
}

const FAQ = [
  { question: 'Intervenez-vous dans tout le 20ème arrondissement ?', answer: 'Oui, nous couvrons l\'intégralité du 20ème arrondissement (75020). Nos équipes connaissent les spécificités locales.' },
  { question: 'Un monte-meubles est-il disponible dans le 20ème ?', answer: 'Oui. Nous évaluons le besoin lors de la visite préalable selon votre étage et la configuration de l\'immeuble.' },
]
...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://grondin-demenagement.fr/demenagement-paris/20eme-arrondissement#service',
  name: 'Déménagement 20ème arrondissement de Paris',
  provider: { '@id': 'https://grondin-demenagement.fr/#business' },
  areaServed: { '@type': 'City', name: 'Paris', addressRegion: 'Île-de-France' },
  url: 'https://grondin-demenagement.fr/demenagement-paris/20eme-arrondissement',
...
export default function DemenagementParis20emeArrPage() {
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ label: 'Déménagement Paris', href: 'https://grondin-demenagement.fr/demenagement-paris' }, { label: 'Paris 20ème', href: 'https://grondin-demenagement.fr/demenagement-paris/20eme-arrondissement' }]} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }} />
      <div className="bg-grondin-900 py-14">
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
          <Breadcrumb items={[{ label: 'Déménagement Paris', href: '/demenagement-paris' }, { label: 'Paris 20ème' }]} />
          <h1 className="text-fluid-4xl font-extrabold text-white mt-4 mb-3">Déménagement dans le 20ème arrondissement de Paris</h1>
          <p className="text-white/70 text-fluid-lg max-w-2xl">Ménilmontant, Père-Lachaise, Belleville — Grondin Déménagement intervient 7j/7 dans le 20ème (75020).</p>
      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-16">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h2 className="text-fluid-2xl font-bold text-neutral-900 mb-4">Votre déménageur dans le 20ème arrondissement</h2>
            <p className="text-neutral-600 leading-relaxed mb-4">Le 20ème arrondissement, entre le cimetière du Père-Lachaise et Ménilmontant, est un arrondissement populaire et créatif. Ses rues en pente et ses immeubles anciens font son charme mais compliquent parfois les déménagements.</p>
            <p className="text-neutral-600 leading-relaxed mb-6">Le 20ème a des rues en pente et des escaliers qui peuvent compliquer la manutention. Grondin Déménagement évalue systématiquement l'accès lors de la visite préalable et prépare une solution adaptée.</p>

            <div className="mb-8">
              <h3 className="text-sm font-semibold text-grondin-700 uppercase tracking-widest mb-3">Quartiers couverts</h3>
              <div className="flex flex-wrap gap-2">
                {['Père-Lachaise', 'Belleville', 'Gambetta', 'Charonne', 'Ménilmontant', 'Réunion', 'Saint-Fargeau'].map((q) => (
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-8">
              <p className="text-sm font-semibold text-blue-800 mb-1">Paris 20ème — Code postal 75020</p>
              <p className="text-xs text-blue-700">Arrondissement populaire et multiculturel en forte transformation. Topographie vallonnée autour de Ménilmontant et Belleville. Nombreux immeubles anciens sans ascenseur — notre monte-meubles extérieur est régulièrement déployé dans les rues de la butte.</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-grondin-900 rounded-3xl p-6 text-white">
              <h3 className="font-bold mb-2">Devis gratuit 20ème</h3>
      ...
      <FAQSection items={FAQ} title="Questions sur le déménagement dans le 20ème" eyebrow="FAQ" />
      <CTASection />
    </div>
  )
}
