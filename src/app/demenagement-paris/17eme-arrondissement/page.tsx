...
export const metadata: Metadata = {
  title: 'Déménagement Paris 17ème — Batignolles, Ternes, Épinettes | Grondin',
  description: 'Déménageur dans le 17ème arrondissement de Paris (Batignolles, Ternes, Épinettes). Grondin Déménagement 7j/7, devis gratuit. 01 85 44 00 50.',
  alternates: { canonical: 'https://grondin-demenagement.fr/demenagement-paris/17eme-arrondissement' },
}

const FAQ = [
  { question: 'Intervenez-vous dans tout le 17ème arrondissement ?', answer: 'Oui, nous couvrons l\'intégralité du 17ème arrondissement (75017). Nos équipes connaissent les spécificités locales.' },
  { question: 'Un monte-meubles est-il disponible dans le 17ème ?', answer: 'Oui. Nous évaluons le besoin lors de la visite préalable selon votre étage et la configuration de l\'immeuble.' },
]
...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://grondin-demenagement.fr/demenagement-paris/17eme-arrondissement#service',
  name: 'Déménagement 17ème arrondissement de Paris',
  provider: { '@id': 'https://grondin-demenagement.fr/#business' },
  areaServed: { '@type': 'City', name: 'Paris', addressRegion: 'Île-de-France' },
  url: 'https://grondin-demenagement.fr/demenagement-paris/17eme-arrondissement',
...
export default function DemenagementParis17emeArrPage() {
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ label: 'Déménagement Paris', href: 'https://grondin-demenagement.fr/demenagement-paris' }, { label: 'Paris 17ème', href: 'https://grondin-demenagement.fr/demenagement-paris/17eme-arrondissement' }]} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }} />
      <div className="bg-grondin-900 py-14">
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
          <Breadcrumb items={[{ label: 'Déménagement Paris', href: '/demenagement-paris' }, { label: 'Paris 17ème' }]} />
          <h1 className="text-fluid-4xl font-extrabold text-white mt-4 mb-3">Déménagement dans le 17ème arrondissement de Paris</h1>
          <p className="text-white/70 text-fluid-lg max-w-2xl">Batignolles, Ternes, Épinettes — Grondin Déménagement intervient 7j/7 dans le 17ème (75017).</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="bg-grondin-900 rounded-3xl p-6 text-white">
              <h3 className="font-bold mb-2">Devis gratuit 17ème</h3>
      ...
      <FAQSection items={FAQ} title="Questions sur le déménagement dans le 17ème" eyebrow="FAQ" />
      <CTASection />
    </div>
  )
}
