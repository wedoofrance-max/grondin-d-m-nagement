...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://grondin-demenagement.fr/demenagement-paris/7eme-arrondissement#service',
  name: 'Déménagement 7ème arrondissement de Paris',
  provider: { '@id': 'https://grondin-demenagement.fr/#business' },
  areaServed: { '@type': 'City', name: 'Paris', addressRegion: 'Île-de-France' },
  url: 'https://grondin-demenagement.fr/demenagement-paris/7eme-arrondissement',
