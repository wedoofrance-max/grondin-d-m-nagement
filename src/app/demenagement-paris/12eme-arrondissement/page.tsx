...
export const metadata: Metadata = {
  title: 'Déménagement Paris 12ème — Nation, Bercy, Bois de Vincennes | Grondin',
  description: 'Déménageur dans le 12ème arrondissement de Paris (Nation, Bercy, Bois de Vincennes). Grondin Déménagement 7j/7, devis gratuit. 01 85 44 00 50.',
  alternates: { canonical: 'https://grondin-demenagement.fr/demenagement-paris/12eme-arrondissement' },
}

const FAQ = [
  { question: 'Intervenez-vous dans tout le 12ème arrondissement ?', answer: 'Oui, nous couvrons l\'intégralité du 12ème arrondissement (75012). Nos équipes connaissent les spécificités locales.' },
  { question: 'Un monte-meubles est-il disponible dans le 12ème ?', answer: 'Oui. Nous évaluons le besoin lors de la visite préalable selon votre étage et la configuration de l\'immeuble.' },
]
...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://grondin-demenagement.fr/demenagement-paris/12eme-arrondissement#service',
  name: 'Déménagement 12ème arrondissement de Paris',
  provider: { '@id': 'https://grondin-demenagement.fr/#business' },
  areaServed: { '@type': 'City', name: 'Paris', addressRegion: 'Île-de-France' },
  url: 'https://grondin-demenagement.fr/demenagement-paris/12eme-arrondissement',
...
export default function DemenagementParis12emeArrPage() {
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ label: 'Déménagement Paris', href: 'https://grondin-demenagement.fr/demenagement-paris' }, { label: 'Paris 12ème', href: 'https://grondin-demenagement.fr/demenagement-paris/12eme-arrondissement' }]} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }} />
      <div className="bg-grondin-900 py-14">
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
          <Breadcrumb items={[{ label: 'Déménagement Paris', href: '/demenagement-paris' }, { label: 'Paris 12ème' }]} />
          <h1 className="text-fluid-4xl font-extrabold text-white mt-4 mb-3">Déménagement dans le 12ème arrondissement de Paris</h1>
          <p className="text-white/70 text-fluid-lg max-w-2xl">Nation, Bercy, Bois de Vincennes — Grondin Déménagement intervient 7j/7 dans le 12ème (75012).</p>
      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-16">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h2 className="text-fluid-2xl font-bold text-neutral-900 mb-4">Votre déménageur dans le 12ème arrondissement</h2>
            <p className="text-neutral-600 leading-relaxed mb-4">Le 12ème arrondissement, entre Nation et le Bois de Vincennes, est un arrondissement résidentiel apprécié des familles. Bercy Village et les quais de Seine en font un quartier agréable, avec une bonne mixité architecturale.</p>
            <p className="text-neutral-600 leading-relaxed mb-6">Le 12ème est accessible et bien équipé. Les immeubles récents disposent souvent d'ascenseurs. Nos équipes interviennent dans tout l'arrondissement, du quai de Bercy à la Porte de Vincennes.</p>

            <div className="mb-8">
              <h3 className="text-sm font-semibold text-grondin-700 uppercase tracking-widest mb-3">Quartiers couverts</h3>
              <div className="flex flex-wrap gap-2">
                {['Bercy', 'Gare de Lyon', 'Reuilly', 'Picpus', 'Bel-Air', 'Charenton côté Paris', 'Daumesnil'].map((q) => (
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-8">
              <p className="text-sm font-semibold text-blue-800 mb-1">Paris 12ème — Code postal 75012</p>
              <p className="text-xs text-blue-700">Arrondissement de taille importante avec tissu varié : logements sociaux, pavillons dans le quartier Bel-Air, immeubles récents autour de Bercy. RER A (Gare de Lyon, Nation). Accès au Bois de Vincennes depuis la Porte Dorée.</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-grondin-900 rounded-3xl p-6 text-white">
              <h3 className="font-bold mb-2">Devis gratuit 12ème</h3>
      ...
      <FAQSection items={FAQ} title="Questions sur le déménagement dans le 12ème" eyebrow="FAQ" />
      <CTASection />
    </div>
  )
}
