...
export const metadata: Metadata = {
  title: 'Déménagement Paris 5ème — Quartier Latin, Mouffetard, Panthéon | Grondin',
  description: 'Déménageur dans le 5ème arrondissement de Paris (Quartier Latin, Mouffetard, Panthéon). Grondin Déménagement 7j/7, devis gratuit. 01 85 44 00 50.',
  alternates: { canonical: 'https://grondin-demenagement.fr/demenagement-paris/5eme-arrondissement' },
}

const FAQ = [
  { question: 'Intervenez-vous dans tout le 5ème arrondissement ?', answer: 'Oui, nous couvrons l\'intégralité du 5ème arrondissement (75005). Nos équipes connaissent les spécificités locales : accès, stationnement, contraintes des immeubles.' },
  { question: 'Un monte-meubles est-il disponible dans le 5ème ?', answer: 'Oui. Lors de la visite préalable, nous évaluons la nécessité d\'un monte-meubles selon votre étage et la configuration de l\'immeuble. Il est inclus dans la formule Premium.' },
]
...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://grondin-demenagement.fr/demenagement-paris/5eme-arrondissement#service',
  name: 'Déménagement 5ème arrondissement de Paris',
  provider: { '@id': 'https://grondin-demenagement.fr/#business' },
  areaServed: { '@type': 'City', name: 'Paris', addressRegion: 'Île-de-France' },
  url: 'https://grondin-demenagement.fr/demenagement-paris/5eme-arrondissement',
...
export default function DemenagementParis5emeArrPage() {
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbSchema items={[
        { label: 'Déménagement Paris', href: 'https://grondin-demenagement.fr/demenagement-paris' },
        { label: 'Paris 5ème', href: 'https://grondin-demenagement.fr/demenagement-paris/5eme-arrondissement' },
      ]} />
      ...
      <div className="bg-grondin-900 py-14">
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
          ...
          <h1 className="text-fluid-4xl font-extrabold text-white mt-4 mb-3">
            Déménagement dans le 5ème arrondissement de Paris
          </h1>
          <p className="text-white/70 text-fluid-lg max-w-2xl">
            Quartier Latin, Mouffetard, Panthéon — Grondin Déménagement intervient 7j/7 dans le 5ème arrondissement (75005).
          </p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="bg-grondin-900 rounded-3xl p-6 text-white">
              <h3 className="font-bold mb-2">Devis gratuit 5ème</h3>
      ...
      <FAQSection items={FAQ} title="Questions sur le déménagement dans le 5ème" eyebrow="FAQ" />
      <CTASection />
    </div>
  )
}
