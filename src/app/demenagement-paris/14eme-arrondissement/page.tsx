      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-16">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-neutral-600 leading-relaxed mb-8">Le 14ème est bien accessible depuis le périphérique sud. Les appartements dans les tours de Montparnasse nécessitent une organisation spécifique avec réservation du monte-charge.</p>
